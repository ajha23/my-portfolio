...
export default function Home() {
    return (
        <div class="w3-container w3-center" style={{padding:"128px 16px"}} id="home">
            ...
            <img src={Image} class="w3-image w3-hide-large w3-hide-small w3-round" style={{display:"block",width:"60%",margin:"auto"}} />
            <img src={Image} class="w3-image w3-hide-large w3-hide-medium w3-round" width="1000" height="1333" />
