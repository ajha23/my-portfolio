                    ...
                    <div className="w3-half">
                        <div id='Chevron' onClick={this.modalClick} className="w3-card-2 w3-hover-shadow w3-padding-32 w3-center" style={{ height: "200px", maxWidth: "100%", margin: "2px" }} >
                            <div className="w3-container">
                                <img src={Data[0].Image} alt="ANZ Bank" width="80px" /><br />
                                <b>{Data[0].AppName}</b>
                            </div>
                        </div>
                    </div>
                    <div className="w3-half">
                        <div id='ANZ Bank' className="w3-card-2 w3-hover-shadow w3-padding-32 w3-center" style={{ backgroundColor: "#003E63", height: "200px", maxWidth: "100%", margin: "2px" }} onClick={this.modalClick} >
                            <div className="w3-container w3-text-white">
                                <img src={Data[1].Image} alt="ANZ Bank" width="200px" /><br />
                                <b>{Data[1].AppName}</b>
                            </div>
                        </div>
                    </div>
